...
public class Service {
    ...
    // A millisecond instant, used to identify when the service last pinged the
    // tracker.
     ...
     * 
     * @param staleTimeLimit the time in seconds within which the service must have
     *                       been refreshed.
     * @return true if the service has gone too long without a refresh, false
     *         otherwise.
     */
    ...
    /**
     * Two services are equal if they have the same address, as no two services can
     * run on the same address.
     * 
